...
module.exports = {
  resolveStyle(style) {
    ...
    if (!styles[style] || styles[style] === undefined || styles[style] === null)
      throw new TypeError(
  ...
  resolveButton(data) {
    if (!data.style)
      ...
      throw new TypeError('NO_BUTTON_LABEL_AND_EMOJI: Please provide button label and/or an emoji.');

    if (!data.label)
      throw new TypeError("NO_BUTTON_LABEL: Please provide button label");
