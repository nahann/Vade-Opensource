    ...
    setTimeout(async () => {
      ...
      if (edgeCheck === 0) {
        newEmbed
          ...
          .setThumbnail(
            "https://media.discordapp.net/attachments/806698907719434240/843627826854887425/kSoXk4n3nJRK7ilnPSX2jdW9bhP2RPOnLon2uFW-nEWN_69-6fgikMFz90LfDQrqplWPrke6Mc_GI2ivvC2ok56s-4KYDvRPGD2W.png?width=410&height=342"
          );
