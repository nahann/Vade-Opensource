   ...
   export const run: RunFunction = async(client, message, args) => {
    ...
    const filter = (reaction, user) => {
      ...
      await msg.edit(result)
        ...
        .catch(collected => {
            message.reply(`The game has been cancelled because you failed to respond in time!`);
        });
...
export const description: string = 'Play a game of Rock Paper Scissors with the Bot!';
