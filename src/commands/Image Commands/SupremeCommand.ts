...
import { MessageAttachment } from 'discord.js';
   ...
   export const run: RunFunction = async(client, message, args) => {
    ...
    const profile_img = await loadImage(join(__dirname, '../../Assets/Images/Supreme.png'));
...
export const description: string = 'Returns an image of the users avatar with a "supreme" effect!';
